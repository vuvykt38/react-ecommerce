...
export const Navbar = () => {
  ...
  const { cart, cartItems, setCart } = useContext(ShopContext);
          ...
          <Link to="/cart" className="text-white hover:text-gray-300">
            <div className="relative py-1">
              <div className="t-0 absolute left-3">
                <p className="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-2  text-xs text-white">{cart.length}</p>
              </div>
