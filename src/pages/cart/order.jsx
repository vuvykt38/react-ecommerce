    ...
    return (
        <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
            <div className="mx-auto max-w-2xl px-4 2xl:px-0">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6 md:mb-8">Your order <span href="#" className="font-medium text-gray-900 dark:text-white">#{Date.now()}</span> will be processed within 24 hours during working days. We will notify you by email once your order has been shipped.</p>
