                                                        ...
                                                        <span className="inline-flex items-center">
                                                            <svg className="me-2 h-4 w-4" fill="none" viewBox="0 0 20 15" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <g mask="url(#a)">
                                                                    ...
                                                                    <path fill="#fff" fillRule="evenodd" d="M4.2 11.933l-.823.433.157-.916-.666-.65.92-.133.412-.834.411.834.92.134-.665.649.157.916-.823-.433zm9.8.7l-.66.194.194-.66-.194-.66.66.193.66-.193-.193.66.193.66-.66-.194zm0-8.866l-.66.193.194-.66-.194-.66.66.193.66-.193-.193.66.193.66-.66-.193zm2.8 2.8l-.66.193.193-.66-.193-.66.66.193.66-.193-.193.66.193.66-.66-.193zm-5.6.933l-.66.193.193-.66-.193-.66.66.194.66-.194-.193.66.193.66-.66-.193zm4.2 1.167l-.33.096.096-.33-.096-.33.33.097.33-.097-.097.33.097.33-.33-.096z" clipRule="evenodd" />
                                                                </g>
                                                                <defs>
                                ...
                                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                                    <div className="flex items-start">
                                        ...
                                        <div className="ms-4 text-sm">
                                            ...
                                            <p id="fedex-text" className="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">No processing fee</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 dark:border-gray-700 dark:bg-gray-800">
                                    <div className="flex items-start">
                                        ...
                                        <div className="ms-4 text-sm">
                                            ...
                                            <p id="fedex-text" className="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">Get it by this week</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {cart.length > 0 ? (
                                cart.map((item) => (
                                    <div className="flex justify-between mt-6" key={item.id}>
                                        <div className="flex">
                                            <img className="h-20 w-20 object-cover rounded" src={item.productImage} alt={item.productName} />
                                            <div className="mx-3">
                                                <h3 className="text-sm text-gray-600">{item.productName}</h3>
                                                <div className="flex items-center mt-2">
                                                    <span className="text-gray-700 mx-2">{item.quantity} x {item.price}</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="flow-root">
                            <div className="-my-3 divide-y divide-gray-200 dark:divide-gray-800">
                                <dl className="flex items-center justify-between gap-4 py-3">
                                    ...
                                    <dd className="text-base font-medium text-gray-900 dark:text-white">${getTotalItemPrice()}</dd>
                                </dl>
                            </div>
                        </div>
                        <div className="space-y-3">
                            <button type="submit" className="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Place Order</button>
                        </div>
                    </div>
                </div>
            </form>
